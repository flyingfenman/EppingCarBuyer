...
// Phones get just the title, so the booking starts straight after it; tablets and laptops show everything.
export function InspectionsHero() {
  return (
    <section className="relative overflow-hidden border-b bg-white">
      ...
      <div className="container relative mx-auto px-4 py-6 sm:py-12 lg:py-16">
        <div className="mx-auto max-w-4xl">
          <div className="flex flex-col">
            <div className="hidden items-center gap-2 self-start rounded-full bg-primary/10 px-4 py-2 text-sm font-bold text-primary sm:inline-flex">
            ...
            <div className="mt-6 hidden items-start gap-3 rounded-2xl border border-primary/15 bg-primary/5 p-4 sm:flex">
