...
const categories: ChecklistCategory[] = [
  {
    ...
    items: [
      ...
      { label: "Drive belts & hoses", rating: "Fair", note: "Minor surface cracking, worth replacing within the next 12 months" },
      ...
      { label: "Engine & gearbox mounts", rating: "Fair", note: "Slight play in the nearside engine mount" },
      { label: "Fluid leaks — oil, coolant, power steering, transmission", rating: "Fair", note: "Very minor weep from the rocker cover gasket, not urgent" },
      ...
      { label: "Shock absorbers / struts", rating: "Fair", note: "Front dampers showing early signs of wear" },
      ...
      { label: "Brake pads & discs, front and rear", rating: "Fair", note: "Front pads around 40% remaining, rears in good order" },
